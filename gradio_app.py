...
def chat_with_character_chatbot(message, history):
    character_chatbot = CharacterChatBot("shivenaggarwal/Naruto-Llama-3-8B",
        ...
        with gr.Row():
            with gr.Column():
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        subtitles_path = gr.Textbox(
                            label="Subtutles or Script Path")
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        classify_text_button.click(classify_text, inputs=[
                                                   text_classifcation_model, text_classifcation_data_path, text_to_classify], outputs=[text_classification_output])
